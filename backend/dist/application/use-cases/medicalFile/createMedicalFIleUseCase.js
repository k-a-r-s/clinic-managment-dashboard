...
class createMedicalFileUseCase {
    ...
    async execute(createMedicalFileDto) {
        ...
        const doctorId = createMedicalFileDto.doctorId ? createMedicalFileDto.doctorId : null;
        const medicalFile = new MedicalFile_1.MedicalFile(doctorId, createMedicalFileDto.data ?? {});
