...
exports.container = exports.dialysisController = exports.prescriptionController = exports.statsController = exports.machineController = exports.roomController = exports.medicalFileController = exports.appointementController = exports.userController = exports.patientController = exports.receptionistController = exports.doctorController = exports.authController = void 0;
...
const PrescriptionRepository_1 = require("../infrastructure/repositories/PrescriptionRepository");
// Controllers
...
const DeleteMachine_1 = require("../application/use-cases/machines/DeleteMachine");
...
const prescriptionController_1 = require("../interface/controllers/prescriptionController");
// Use Cases - Users
...
const UpdateCurrentUserUseCase_1 = require("../application/use-cases/users/UpdateCurrentUserUseCase");
// Use Cases - Doctor
...
const UpdateAppointmentUseCase_1 = require("../application/use-cases/appointement/UpdateAppointmentUseCase");
// Use Cases - Room
...
const CreatePrescriptionUseCase_1 = require("../application/use-cases/prescription/CreatePrescriptionUseCase");
const GetPrescriptionsUseCase_1 = require("../application/use-cases/prescription/GetPrescriptionsUseCase");
const GetPrescriptionByIdUseCase_1 = require("../application/use-cases/prescription/GetPrescriptionByIdUseCase");
const GetPrescriptionsByPatientIdUseCase_1 = require("../application/use-cases/prescription/GetPrescriptionsByPatientIdUseCase");
const UpdatePrescriptionUseCase_1 = require("../application/use-cases/prescription/UpdatePrescriptionUseCase");
const DeletePrescriptionUseCase_1 = require("../application/use-cases/prescription/DeletePrescriptionUseCase");
// Dialysis
const DialysisRepository_1 = require("../infrastructure/repositories/DialysisRepository");
const CreateDialysisPatient_1 = require("../application/use-cases/dialysis/CreateDialysisPatient");
const GetAllDialysisPatients_1 = require("../application/use-cases/dialysis/GetAllDialysisPatients");
const CreateProtocol_1 = require("../application/use-cases/dialysis/CreateProtocol");
const GetProtocolByPatientId_1 = require("../application/use-cases/dialysis/GetProtocolByPatientId");
const CreateSession_1 = require("../application/use-cases/dialysis/CreateSession");
const GetSessionsByPatientId_1 = require("../application/use-cases/dialysis/GetSessionsByPatientId");
const UpdateDialysisPatient_1 = require("../application/use-cases/dialysis/UpdateDialysisPatient");
const UpdateProtocol_1 = require("../application/use-cases/dialysis/UpdateProtocol");
const UpdateSession_1 = require("../application/use-cases/dialysis/UpdateSession");
const GetSessionById_1 = require("../application/use-cases/dialysis/GetSessionById");
const DeleteSession_1 = require("../application/use-cases/dialysis/DeleteSession");
const dialysisController_1 = require("../interface/controllers/dialysisController");
// Repositories
...
const prescriptionRepository = new PrescriptionRepository_1.PrescriptionRepository();
const dialysisRepository = new DialysisRepository_1.DialysisRepository();
// Services
...
// Use Cases - Patient
const getPatientByIdUseCase = new getPatientByIdUseCase_1.GetPatientByIdUseCase(patientRepository, medicalFileRepository);
...
// Use Cases - Appointment
const addAppointementUseCase = new AddAppointementUseCase_1.AddAppointementUseCase(appointementRepository, medicalFileRepository, roomRepository);
...
const updateAppointmentUseCaseInstance = new UpdateAppointmentUseCase_1.UpdateAppointmentUseCase(appointementRepository);
// Use Cases - Room
...
const deleteMachineUseCase = new DeleteMachine_1.DeleteMachine(machineRepository);
...
const getUserByIdUseCaseInstance = new GetUserByIdUseCase_1.GetUserByIdUseCase(userRepository);
const updateUserUseCaseInstance = new UpdateUserUseCase_1.UpdateUserUseCase(userRepository);
const deleteUserUseCaseInstance = new DeleteUserUseCase_1.DeleteUserUseCase(userRepository);
const changePasswordUseCase = new ChangePasswordUseCase_1.ChangePasswordUseCase(userRepository);
const updateCurrentUserUseCase = new UpdateCurrentUserUseCase_1.UpdateCurrentUserUseCase(userRepository);
// Use Cases - Appointment History
...
// Use Cases - Prescription
const createPrescriptionUseCase = new CreatePrescriptionUseCase_1.CreatePrescriptionUseCase(prescriptionRepository, medicalFileRepository);
const getPrescriptionsUseCase = new GetPrescriptionsUseCase_1.GetPrescriptionsUseCase(prescriptionRepository);
const getPrescriptionByIdUseCase = new GetPrescriptionByIdUseCase_1.GetPrescriptionByIdUseCase(prescriptionRepository);
const getPrescriptionsByPatientIdUseCase = new GetPrescriptionsByPatientIdUseCase_1.GetPrescriptionsByPatientIdUseCase(prescriptionRepository);
...
// Use Cases - Dialysis
const createDialysisPatientUseCase = new CreateDialysisPatient_1.CreateDialysisPatient(dialysisRepository);
const getAllDialysisPatientsUseCase = new GetAllDialysisPatients_1.GetAllDialysisPatients(dialysisRepository);
const updateDialysisPatientUseCase = new UpdateDialysisPatient_1.UpdateDialysisPatient(dialysisRepository);
const createProtocolUseCase = new CreateProtocol_1.CreateProtocol(dialysisRepository);
const getProtocolByPatientIdUseCase = new GetProtocolByPatientId_1.GetProtocolByPatientId(dialysisRepository);
const updateProtocolUseCase = new UpdateProtocol_1.UpdateProtocol(dialysisRepository);
const createSessionUseCase = new CreateSession_1.CreateSession(dialysisRepository, medicalFileRepository);
const getSessionsByPatientIdUseCase = new GetSessionsByPatientId_1.GetSessionsByPatientId(dialysisRepository);
const getSessionByIdUseCase = new GetSessionById_1.GetSessionById(dialysisRepository);
const updateSessionUseCase = new UpdateSession_1.UpdateSession(dialysisRepository);
const deleteSessionUseCase = new DeleteSession_1.DeleteSession(dialysisRepository);
// Controllers
exports.authController = new authController_1.AuthController(userAuthService, changePasswordUseCase, updateCurrentUserUseCase);
...
exports.userController = new userController_1.UserController(userAuthService, getAllUsersUseCase, getUserByIdUseCaseInstance, updateUserUseCaseInstance, deleteUserUseCaseInstance);
exports.appointementController = new appointmentController_1.AppointementController(addAppointementUseCase, getAppointementsUseCase, getAppointmentsByDoctorUseCase, getAppointementsByPatientUseCase, deleteAppointementUseCaseInstance, getAppointmentByIdUseCase, updateAppointmentUseCaseInstance, getAppointmentHistoryUseCase, getHistoriesByPatientUseCase, updateAppointmentHistoryUseCase, deleteAppointmentHistoryUseCase, appointmentCompletedUseCase);
...
exports.machineController = new machineController_1.MachineController(createMachineUseCase, getAllMachinesUseCase, getMachineByIdUseCase, updateMachineUseCase, deactivateMachineUseCase, deleteMachineUseCase, getMachineStatsUseCase, getMachineStatsFormattedUseCase);
...
exports.prescriptionController = new prescriptionController_1.PrescriptionController(createPrescriptionUseCase, getPrescriptionsUseCase, getPrescriptionByIdUseCase, getPrescriptionsByPatientIdUseCase, updatePrescriptionUseCase, deletePrescriptionUseCase);
exports.dialysisController = new dialysisController_1.DialysisController(createDialysisPatientUseCase, getAllDialysisPatientsUseCase, updateDialysisPatientUseCase, createProtocolUseCase, getProtocolByPatientIdUseCase, updateProtocolUseCase, createSessionUseCase, getSessionsByPatientIdUseCase, getSessionByIdUseCase, updateSessionUseCase, deleteSessionUseCase);
...
exports.container.register("prescriptionController", exports.prescriptionController);
exports.container.register("dialysisController", exports.dialysisController);
