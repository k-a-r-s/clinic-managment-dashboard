...
const prescription_route_1 = __importDefault(require("./interface/routes/prescription.route"));
const dialysis_route_1 = __importDefault(require("./interface/routes/dialysis.route"));
...
// Dialysis
app.use("/dialysis", dialysis_route_1.default);
