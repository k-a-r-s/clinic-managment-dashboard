...
class MachineController {
    constructor(createMachineUseCase, getAllMachinesUseCase, getMachineByIdUseCase, updateMachineUseCase, deactivateMachineUseCase, deleteMachineUseCase, getMachineStatsUseCase, getMachineStatsFormattedUseCase) {
        ...
        this.deleteMachineUseCase = deleteMachineUseCase;
    ...
    async deleteMachine(req, res) {
        ...
        return ResponseFormatter_1.ResponseFormatter.success(res, null, "Machine deleted successfully");
    }
