 ...
 *         description: Unauthorized
 */
router.get('/history/:appointmentId', authMiddleware_1.authMiddleware, (0, requireRole_1.requireRole)([roles_1.Role.DOCTOR, roles_1.Role.ADMIN]), (0, asyncWrapper_1.asyncWrapper)(container_1.appointementController.getHistoryByAppointmentId.bind(container_1.appointementController)));
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.get('/history/patient/:patientId', authMiddleware_1.authMiddleware, (0, requireRole_1.requireRole)([roles_1.Role.DOCTOR, roles_1.Role.ADMIN]), (0, asyncWrapper_1.asyncWrapper)(container_1.appointementController.getHistoriesByPatientId.bind(container_1.appointementController)));
/**
 * @swagger
 * /appointments/history/{appointmentId}:
 *   patch:
 ...
 */
router.delete('/history/:appointmentId', authMiddleware_1.authMiddleware, (0, requireRole_1.requireRole)([roles_1.Role.ADMIN]), (0, asyncWrapper_1.asyncWrapper)(container_1.appointementController.deleteHistory.bind(container_1.appointementController)));
