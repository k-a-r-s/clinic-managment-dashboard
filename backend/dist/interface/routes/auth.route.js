...
const LoginDto_1 = require("../../application/dto/requests/LoginDto");
 ...
 */
router.post("/login", (0, Validate_1.validate)(LoginDto_1.LoginDto), (0, asyncWrapper_1.asyncWrapper)(container_1.authController.login.bind(container_1.authController)));
/**
 * @swagger
 * /auth/logout:
 *   post:
 ...
 */
router.post("/logout", authMiddleware_1.authMiddleware, (0, asyncWrapper_1.asyncWrapper)(container_1.authController.logout.bind(container_1.authController)));
/**
 * @swagger
 * /auth/refresh-token:
 *   post:
 ...
 */
router.post("/refresh-token", (0, asyncWrapper_1.asyncWrapper)(container_1.authController.refreshToken.bind(container_1.authController)));
/**
 * @swagger
 * /auth/me:
 *   post:
 ...
 */
router.post("/me", authMiddleware_1.authMiddleware, (0, asyncWrapper_1.asyncWrapper)(container_1.authController.getMe.bind(container_1.authController)));
/**
 * @swagger
 * /auth/profile:
 *   put:
 ...
 *         description: Unauthorized
 */
router.put("/profile", authMiddleware_1.authMiddleware, (0, asyncWrapper_1.asyncWrapper)(container_1.authController.updateProfile.bind(container_1.authController)));
/**
 * @swagger
 ...
 */
router.post("/change-password", authMiddleware_1.authMiddleware, (0, asyncWrapper_1.asyncWrapper)(container_1.authController.changePassword.bind(container_1.authController)));
