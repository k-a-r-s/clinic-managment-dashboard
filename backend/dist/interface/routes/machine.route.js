...
const createMachineDto_1 = require("../../application/dto/requests/createMachineDto");
 ...
 */
/** Create machine */
router.post("/", authMiddleware_1.authMiddleware, (0, Validate_1.validate)(createMachineDto_1.createMachineSchemaDto), (0, asyncWrapper_1.asyncWrapper)(container_1.machineController.createMachine.bind(container_1.machineController)));
/** Get all machines */
...
/** Deactivate machine */
router.post("/:id/deactivate", authMiddleware_1.authMiddleware, (0, requireRole_1.requireRole)([roles_1.Role.ADMIN]), (0, asyncWrapper_1.asyncWrapper)(container_1.machineController.deactivateMachine.bind(container_1.machineController)));
/** Delete machine */
router.delete("/:id", authMiddleware_1.authMiddleware, (0, requireRole_1.requireRole)([roles_1.Role.ADMIN]), (0, asyncWrapper_1.asyncWrapper)(container_1.machineController.deleteMachine.bind(container_1.machineController)));
