...
export function MedicalFileForm({
  ...
  const tabs = [
    { id: "nephropathy", label: "Nephropathy Info" },
    { id: "vascular", label: "Vascular Access" },
    { id: "dialysis", label: "Dialysis Protocol" },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        {/* Nephropathy Info Tab */}
        {activeTab === "nephropathy" && (
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          const days = e.target.checked
                            ? [
                                ...medicalFile.dialysisProtocol.dialysisDays,
                                day,
                              ]
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-purple-700">
                    <strong>Dose History:</strong> When changing doses, add a
                    new history entry instead of editing. This preserves the
                    medication timeline.
                  </p>
                </div>
              </div>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 space-y-3">
                      ...
                      {!readOnly &&
                        med.currentTreatment.status === "active" && (
                          <Button
                            onClick={() =>
                              discontinueCurrentTreatment(medIndex)
                            }
                            variant="outline"
                            size="sm"
                            className="text-red-600 hover:text-red-700 hover:bg-red-50"
